 ...
 */
class Union8NullableImp6<T1, T2, T3, T4, T5, T6, T7, T8> implements Union8Nullable<T1, T2, T3, T4, T5, T6, T7, T8> {
  @Nullable
  private final T6 value;

  Union8NullableImp6(@Nullable final T6 value) {
    this.value = value;
  }
  ...
  public boolean equals(final Object o) {
    ...
    final Union8NullableImp6<?, ?, ?, ?, ?, ?, ?, ?> that = (Union8NullableImp6<?, ?, ?, ?, ?, ?, ?, ?>) o;
  ...
  public String toString() {
    return "Union8NullableImp6{value="+value+"}";
  }
}
