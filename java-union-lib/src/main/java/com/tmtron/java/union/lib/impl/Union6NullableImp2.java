 ...
 */
class Union6NullableImp2<T1, T2, T3, T4, T5, T6> implements Union6Nullable<T1, T2, T3, T4, T5, T6> {
  @Nullable
  private final T2 value;

  Union6NullableImp2(@Nullable final T2 value) {
    this.value = value;
  }
  ...
  public boolean equals(final Object o) {
    ...
    final Union6NullableImp2<?, ?, ?, ?, ?, ?> that = (Union6NullableImp2<?, ?, ?, ?, ?, ?>) o;
  ...
  public String toString() {
    return "Union6NullableImp2{value="+value+"}";
  }
}
