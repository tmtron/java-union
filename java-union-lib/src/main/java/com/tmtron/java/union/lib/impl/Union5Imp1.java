 ...
 */
class Union5Imp1<T1, T2, T3, T4, T5> implements Union5<T1, T2, T3, T4, T5> {
  @Nonnull
  private final T1 value;

  Union5Imp1(@Nonnull final T1 value) {
  ...
  public boolean equals(final Object o) {
    ...
    final Union5Imp1<?, ?, ?, ?, ?> that = (Union5Imp1<?, ?, ?, ?, ?>) o;
