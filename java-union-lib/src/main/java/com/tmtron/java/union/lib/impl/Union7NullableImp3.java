 ...
 */
class Union7NullableImp3<T1, T2, T3, T4, T5, T6, T7> implements Union7Nullable<T1, T2, T3, T4, T5, T6, T7> {
  @Nullable
  private final T3 value;

  Union7NullableImp3(@Nullable final T3 value) {
    this.value = value;
  }
  ...
  public boolean equals(final Object o) {
    ...
    final Union7NullableImp3<?, ?, ?, ?, ?, ?, ?> that = (Union7NullableImp3<?, ?, ?, ?, ?, ?, ?>) o;
  ...
  public String toString() {
    return "Union7NullableImp3{value="+value+"}";
  }
}
