 ...
 */
class Union6Imp1<T1, T2, T3, T4, T5, T6> implements Union6<T1, T2, T3, T4, T5, T6> {
  @Nonnull
  private final T1 value;

  Union6Imp1(@Nonnull final T1 value) {
  ...
  public boolean equals(final Object o) {
    ...
    final Union6Imp1<?, ?, ?, ?, ?, ?> that = (Union6Imp1<?, ?, ?, ?, ?, ?>) o;
