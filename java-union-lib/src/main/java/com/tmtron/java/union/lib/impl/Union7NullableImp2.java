 ...
 */
class Union7NullableImp2<T1, T2, T3, T4, T5, T6, T7> implements Union7Nullable<T1, T2, T3, T4, T5, T6, T7> {
  @Nullable
  private final T2 value;

  Union7NullableImp2(@Nullable final T2 value) {
    this.value = value;
  }
  ...
  public boolean equals(final Object o) {
    ...
    final Union7NullableImp2<?, ?, ?, ?, ?, ?, ?> that = (Union7NullableImp2<?, ?, ?, ?, ?, ?, ?>) o;
  ...
  public String toString() {
    return "Union7NullableImp2{value="+value+"}";
  }
}
