 ...
 */
class Union6Imp5<T1, T2, T3, T4, T5, T6> implements Union6<T1, T2, T3, T4, T5, T6> {
  @Nonnull
  private final T5 value;

  Union6Imp5(@Nonnull final T5 value) {
  ...
  public boolean equals(final Object o) {
    ...
    final Union6Imp5<?, ?, ?, ?, ?, ?> that = (Union6Imp5<?, ?, ?, ?, ?, ?>) o;
