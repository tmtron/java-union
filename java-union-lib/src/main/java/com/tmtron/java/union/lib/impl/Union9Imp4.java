 ...
 */
class Union9Imp4<T1, T2, T3, T4, T5, T6, T7, T8, T9> implements Union9<T1, T2, T3, T4, T5, T6, T7, T8, T9> {
  @Nonnull
  private final T4 value;

  Union9Imp4(@Nonnull final T4 value) {
  ...
  public boolean equals(final Object o) {
    ...
    final Union9Imp4<?, ?, ?, ?, ?, ?, ?, ?, ?> that = (Union9Imp4<?, ?, ?, ?, ?, ?, ?, ?, ?>) o;
