 ...
 */
class Union8Imp7<T1, T2, T3, T4, T5, T6, T7, T8> implements Union8<T1, T2, T3, T4, T5, T6, T7, T8> {
  @Nonnull
  private final T7 value;

  Union8Imp7(@Nonnull final T7 value) {
  ...
  public boolean equals(final Object o) {
    ...
    final Union8Imp7<?, ?, ?, ?, ?, ?, ?, ?> that = (Union8Imp7<?, ?, ?, ?, ?, ?, ?, ?>) o;
