 ...
 */
class Union8Imp1<T1, T2, T3, T4, T5, T6, T7, T8> implements Union8<T1, T2, T3, T4, T5, T6, T7, T8> {
  @Nonnull
  private final T1 value;

  Union8Imp1(@Nonnull final T1 value) {
  ...
  public boolean equals(final Object o) {
    ...
    final Union8Imp1<?, ?, ?, ?, ?, ?, ?, ?> that = (Union8Imp1<?, ?, ?, ?, ?, ?, ?, ?>) o;
