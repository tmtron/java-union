 ...
 */
class Union9NullableImp1<T1, T2, T3, T4, T5, T6, T7, T8, T9> implements Union9Nullable<T1, T2, T3, T4, T5, T6, T7, T8, T9> {
  @Nullable
  private final T1 value;

  Union9NullableImp1(@Nullable final T1 value) {
    this.value = value;
  }
  ...
  public boolean equals(final Object o) {
    ...
    final Union9NullableImp1<?, ?, ?, ?, ?, ?, ?, ?, ?> that = (Union9NullableImp1<?, ?, ?, ?, ?, ?, ?, ?, ?>) o;
  ...
  public String toString() {
    return "Union9NullableImp1{value="+value+"}";
  }
}
