 ...
 */
class Union4NullableImp2<T1, T2, T3, T4> implements Union4Nullable<T1, T2, T3, T4> {
  @Nullable
  private final T2 value;

  Union4NullableImp2(@Nullable final T2 value) {
    this.value = value;
  }
  ...
  public boolean equals(final Object o) {
    ...
    final Union4NullableImp2<?, ?, ?, ?> that = (Union4NullableImp2<?, ?, ?, ?>) o;
  ...
  public String toString() {
    return "Union4NullableImp2{value="+value+"}";
  }
}
