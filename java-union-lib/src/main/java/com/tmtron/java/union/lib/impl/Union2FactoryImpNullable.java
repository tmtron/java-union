 ...
 */
class Union2FactoryImpNullable<T1, T2> implements Union2FactoryNullable<T1, T2> {
  /**
  ...
  @CheckReturnValue
  @Override
  public final Union2Nullable<T1, T2> element1(@Nullable T1 element1) {
    return new Union2NullableImp1<>(element1);
  }
  ...
  @CheckReturnValue
  @Override
  public final Union2Nullable<T1, T2> element2(@Nullable T2 element2) {
    return new Union2NullableImp2<>(element2);
  }
}
