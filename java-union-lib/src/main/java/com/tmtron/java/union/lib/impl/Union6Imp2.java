 ...
 */
class Union6Imp2<T1, T2, T3, T4, T5, T6> implements Union6<T1, T2, T3, T4, T5, T6> {
  @Nonnull
  private final T2 value;

  Union6Imp2(@Nonnull final T2 value) {
  ...
  public boolean equals(final Object o) {
    ...
    final Union6Imp2<?, ?, ?, ?, ?, ?> that = (Union6Imp2<?, ?, ?, ?, ?, ?>) o;
