 ...
 */
class Union3NullableImp3<T1, T2, T3> implements Union3Nullable<T1, T2, T3> {
  @Nullable
  private final T3 value;

  Union3NullableImp3(@Nullable final T3 value) {
    this.value = value;
  }
  ...
  public boolean equals(final Object o) {
    ...
    final Union3NullableImp3<?, ?, ?> that = (Union3NullableImp3<?, ?, ?>) o;
  ...
  public String toString() {
    return "Union3NullableImp3{value="+value+"}";
  }
}
