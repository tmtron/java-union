 ...
 */
class Union4FactoryImp<T1, T2, T3, T4> implements Union4Factory<T1, T2, T3, T4> {
  /**
  ...
  @CheckReturnValue
  @Override
  public final Union4<T1, T2, T3, T4> element1(@Nonnull T1 element1) {
    return new Union4Imp1<>(element1);
  }
  ...
  @CheckReturnValue
  @Override
  public final Union4<T1, T2, T3, T4> element2(@Nonnull T2 element2) {
    return new Union4Imp2<>(element2);
  }
  ...
  @CheckReturnValue
  @Override
  public final Union4<T1, T2, T3, T4> element3(@Nonnull T3 element3) {
    return new Union4Imp3<>(element3);
  }
  ...
  @CheckReturnValue
  @Override
  public final Union4<T1, T2, T3, T4> element4(@Nonnull T4 element4) {
    return new Union4Imp4<>(element4);
  }
}
