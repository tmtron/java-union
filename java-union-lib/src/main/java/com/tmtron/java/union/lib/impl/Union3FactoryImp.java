 ...
 */
class Union3FactoryImp<T1, T2, T3> implements Union3Factory<T1, T2, T3> {
  /**
  ...
  @CheckReturnValue
  @Override
  public final Union3<T1, T2, T3> element1(@Nonnull T1 element1) {
    return new Union3Imp1<>(element1);
  }
  ...
  @CheckReturnValue
  @Override
  public final Union3<T1, T2, T3> element2(@Nonnull T2 element2) {
    return new Union3Imp2<>(element2);
  }
  ...
  @CheckReturnValue
  @Override
  public final Union3<T1, T2, T3> element3(@Nonnull T3 element3) {
    return new Union3Imp3<>(element3);
  }
}
