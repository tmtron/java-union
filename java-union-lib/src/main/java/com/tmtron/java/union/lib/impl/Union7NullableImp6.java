 ...
 */
class Union7NullableImp6<T1, T2, T3, T4, T5, T6, T7> implements Union7Nullable<T1, T2, T3, T4, T5, T6, T7> {
  @Nullable
  private final T6 value;

  Union7NullableImp6(@Nullable final T6 value) {
    this.value = value;
  }
  ...
  public boolean equals(final Object o) {
    ...
    final Union7NullableImp6<?, ?, ?, ?, ?, ?, ?> that = (Union7NullableImp6<?, ?, ?, ?, ?, ?, ?>) o;
  ...
  public String toString() {
    return "Union7NullableImp6{value="+value+"}";
  }
}
