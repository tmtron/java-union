 ...
 */
class Union8NullableImp3<T1, T2, T3, T4, T5, T6, T7, T8> implements Union8Nullable<T1, T2, T3, T4, T5, T6, T7, T8> {
  @Nullable
  private final T3 value;

  Union8NullableImp3(@Nullable final T3 value) {
    this.value = value;
  }
  ...
  public boolean equals(final Object o) {
    ...
    final Union8NullableImp3<?, ?, ?, ?, ?, ?, ?, ?> that = (Union8NullableImp3<?, ?, ?, ?, ?, ?, ?, ?>) o;
  ...
  public String toString() {
    return "Union8NullableImp3{value="+value+"}";
  }
}
