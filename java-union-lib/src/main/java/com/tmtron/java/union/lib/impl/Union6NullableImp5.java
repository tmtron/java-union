 ...
 */
class Union6NullableImp5<T1, T2, T3, T4, T5, T6> implements Union6Nullable<T1, T2, T3, T4, T5, T6> {
  @Nullable
  private final T5 value;

  Union6NullableImp5(@Nullable final T5 value) {
    this.value = value;
  }
  ...
  public boolean equals(final Object o) {
    ...
    final Union6NullableImp5<?, ?, ?, ?, ?, ?> that = (Union6NullableImp5<?, ?, ?, ?, ?, ?>) o;
  ...
  public String toString() {
    return "Union6NullableImp5{value="+value+"}";
  }
}
