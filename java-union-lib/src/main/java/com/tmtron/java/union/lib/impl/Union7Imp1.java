 ...
 */
class Union7Imp1<T1, T2, T3, T4, T5, T6, T7> implements Union7<T1, T2, T3, T4, T5, T6, T7> {
  @Nonnull
  private final T1 value;

  Union7Imp1(@Nonnull final T1 value) {
  ...
  public boolean equals(final Object o) {
    ...
    final Union7Imp1<?, ?, ?, ?, ?, ?, ?> that = (Union7Imp1<?, ?, ?, ?, ?, ?, ?>) o;
