 ...
 */
class Union9NullableImp3<T1, T2, T3, T4, T5, T6, T7, T8, T9> implements Union9Nullable<T1, T2, T3, T4, T5, T6, T7, T8, T9> {
  @Nullable
  private final T3 value;

  Union9NullableImp3(@Nullable final T3 value) {
    this.value = value;
  }
  ...
  public boolean equals(final Object o) {
    ...
    final Union9NullableImp3<?, ?, ?, ?, ?, ?, ?, ?, ?> that = (Union9NullableImp3<?, ?, ?, ?, ?, ?, ?, ?, ?>) o;
  ...
  public String toString() {
    return "Union9NullableImp3{value="+value+"}";
  }
}
