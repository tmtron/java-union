...
/**
 * Union Implementation that has 8 different types.
 ...
 */
class Union8NullableImp8<T1, T2, T3, T4, T5, T6, T7, T8> implements Union8Nullable<T1, T2, T3, T4, T5, T6, T7, T8> {
  @Nullable
  private final T8 value;

  Union8NullableImp8(@Nullable final T8 value) {
    this.value = value;
  }
  ...
  public boolean equals(final Object o) {
    ...
    final Union8NullableImp8<?, ?, ?, ?, ?, ?, ?, ?> that = (Union8NullableImp8<?, ?, ?, ?, ?, ?, ?, ?>) o;
  ...
  public String toString() {
    return "Union8NullableImp8{value="+value+"}";
  }
}
