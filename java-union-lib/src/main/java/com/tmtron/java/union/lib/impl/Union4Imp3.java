 ...
 */
class Union4Imp3<T1, T2, T3, T4> implements Union4<T1, T2, T3, T4> {
  @Nonnull
  private final T3 value;

  Union4Imp3(@Nonnull final T3 value) {
  ...
  public boolean equals(final Object o) {
    ...
    final Union4Imp3<?, ?, ?, ?> that = (Union4Imp3<?, ?, ?, ?>) o;
