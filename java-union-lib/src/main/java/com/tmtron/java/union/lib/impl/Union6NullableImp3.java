 ...
 */
class Union6NullableImp3<T1, T2, T3, T4, T5, T6> implements Union6Nullable<T1, T2, T3, T4, T5, T6> {
  @Nullable
  private final T3 value;

  Union6NullableImp3(@Nullable final T3 value) {
    this.value = value;
  }
  ...
  public boolean equals(final Object o) {
    ...
    final Union6NullableImp3<?, ?, ?, ?, ?, ?> that = (Union6NullableImp3<?, ?, ?, ?, ?, ?>) o;
  ...
  public String toString() {
    return "Union6NullableImp3{value="+value+"}";
  }
}
