 ...
 */
class Union9NullableImp2<T1, T2, T3, T4, T5, T6, T7, T8, T9> implements Union9Nullable<T1, T2, T3, T4, T5, T6, T7, T8, T9> {
  @Nullable
  private final T2 value;

  Union9NullableImp2(@Nullable final T2 value) {
    this.value = value;
  }
  ...
  public boolean equals(final Object o) {
    ...
    final Union9NullableImp2<?, ?, ?, ?, ?, ?, ?, ?, ?> that = (Union9NullableImp2<?, ?, ?, ?, ?, ?, ?, ?, ?>) o;
  ...
  public String toString() {
    return "Union9NullableImp2{value="+value+"}";
  }
}
