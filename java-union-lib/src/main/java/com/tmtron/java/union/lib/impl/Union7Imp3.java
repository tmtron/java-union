 ...
 */
class Union7Imp3<T1, T2, T3, T4, T5, T6, T7> implements Union7<T1, T2, T3, T4, T5, T6, T7> {
  @Nonnull
  private final T3 value;

  Union7Imp3(@Nonnull final T3 value) {
  ...
  public boolean equals(final Object o) {
    ...
    final Union7Imp3<?, ?, ?, ?, ?, ?, ?> that = (Union7Imp3<?, ?, ?, ?, ?, ?, ?>) o;
