 ...
 */
class Union8Imp2<T1, T2, T3, T4, T5, T6, T7, T8> implements Union8<T1, T2, T3, T4, T5, T6, T7, T8> {
  @Nonnull
  private final T2 value;

  Union8Imp2(@Nonnull final T2 value) {
  ...
  public boolean equals(final Object o) {
    ...
    final Union8Imp2<?, ?, ?, ?, ?, ?, ?, ?> that = (Union8Imp2<?, ?, ?, ?, ?, ?, ?, ?>) o;
