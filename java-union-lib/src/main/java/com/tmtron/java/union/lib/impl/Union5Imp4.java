 ...
 */
class Union5Imp4<T1, T2, T3, T4, T5> implements Union5<T1, T2, T3, T4, T5> {
  @Nonnull
  private final T4 value;

  Union5Imp4(@Nonnull final T4 value) {
  ...
  public boolean equals(final Object o) {
    ...
    final Union5Imp4<?, ?, ?, ?, ?> that = (Union5Imp4<?, ?, ?, ?, ?>) o;
