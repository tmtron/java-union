 ...
 */
class Union8NullableImp1<T1, T2, T3, T4, T5, T6, T7, T8> implements Union8Nullable<T1, T2, T3, T4, T5, T6, T7, T8> {
  @Nullable
  private final T1 value;

  Union8NullableImp1(@Nullable final T1 value) {
    this.value = value;
  }
  ...
  public boolean equals(final Object o) {
    ...
    final Union8NullableImp1<?, ?, ?, ?, ?, ?, ?, ?> that = (Union8NullableImp1<?, ?, ?, ?, ?, ?, ?, ?>) o;
  ...
  public String toString() {
    return "Union8NullableImp1{value="+value+"}";
  }
}
