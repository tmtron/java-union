 ...
 * @param <T5> type of element for this implementation class
 * @param <T6> type of element
 * @param <T7> type of element
 * @param <T8> type of element
 * @param <T9> type of element
 */
class Union9NullableImp5<T1, T2, T3, T4, T5, T6, T7, T8, T9> implements Union9Nullable<T1, T2, T3, T4, T5, T6, T7, T8, T9> {
  @Nullable
  private final T5 value;

  Union9NullableImp5(@Nullable final T5 value) {
    this.value = value;
  }
  ...
  public boolean equals(final Object o) {
    ...
    final Union9NullableImp5<?, ?, ?, ?, ?, ?, ?, ?, ?> that = (Union9NullableImp5<?, ?, ?, ?, ?, ?, ?, ?, ?>) o;
  ...
  public String toString() {
    return "Union9NullableImp5{value="+value+"}";
  }
}
