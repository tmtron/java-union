 ...
 */
class Union7Imp7<T1, T2, T3, T4, T5, T6, T7> implements Union7<T1, T2, T3, T4, T5, T6, T7> {
  @Nonnull
  private final T7 value;

  Union7Imp7(@Nonnull final T7 value) {
  ...
  public boolean equals(final Object o) {
    ...
    final Union7Imp7<?, ?, ?, ?, ?, ?, ?> that = (Union7Imp7<?, ?, ?, ?, ?, ?, ?>) o;
