 ...
 */
class Union5NullableImp4<T1, T2, T3, T4, T5> implements Union5Nullable<T1, T2, T3, T4, T5> {
  @Nullable
  private final T4 value;

  Union5NullableImp4(@Nullable final T4 value) {
    this.value = value;
  }
  ...
  public boolean equals(final Object o) {
    ...
    final Union5NullableImp4<?, ?, ?, ?, ?> that = (Union5NullableImp4<?, ?, ?, ?, ?>) o;
  ...
  public String toString() {
    return "Union5NullableImp4{value="+value+"}";
  }
}
