 ...
 */
class Union5NullableImp1<T1, T2, T3, T4, T5> implements Union5Nullable<T1, T2, T3, T4, T5> {
  @Nullable
  private final T1 value;

  Union5NullableImp1(@Nullable final T1 value) {
    this.value = value;
  }
  ...
  public boolean equals(final Object o) {
    ...
    final Union5NullableImp1<?, ?, ?, ?, ?> that = (Union5NullableImp1<?, ?, ?, ?, ?>) o;
  ...
  public String toString() {
    return "Union5NullableImp1{value="+value+"}";
  }
}
