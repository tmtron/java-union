 ...
 */
class Union9Imp8<T1, T2, T3, T4, T5, T6, T7, T8, T9> implements Union9<T1, T2, T3, T4, T5, T6, T7, T8, T9> {
  @Nonnull
  private final T8 value;

  Union9Imp8(@Nonnull final T8 value) {
  ...
  public boolean equals(final Object o) {
    ...
    final Union9Imp8<?, ?, ?, ?, ?, ?, ?, ?, ?> that = (Union9Imp8<?, ?, ?, ?, ?, ?, ?, ?, ?>) o;
