 ...
 */
class Union9Imp1<T1, T2, T3, T4, T5, T6, T7, T8, T9> implements Union9<T1, T2, T3, T4, T5, T6, T7, T8, T9> {
  @Nonnull
  private final T1 value;

  Union9Imp1(@Nonnull final T1 value) {
  ...
  public boolean equals(final Object o) {
    ...
    final Union9Imp1<?, ?, ?, ?, ?, ?, ?, ?, ?> that = (Union9Imp1<?, ?, ?, ?, ?, ?, ?, ?, ?>) o;
