 ...
 */
class Union5NullableImp5<T1, T2, T3, T4, T5> implements Union5Nullable<T1, T2, T3, T4, T5> {
  @Nullable
  private final T5 value;

  Union5NullableImp5(@Nullable final T5 value) {
    this.value = value;
  }
  ...
  public boolean equals(final Object o) {
    ...
    final Union5NullableImp5<?, ?, ?, ?, ?> that = (Union5NullableImp5<?, ?, ?, ?, ?>) o;
  ...
  public String toString() {
    return "Union5NullableImp5{value="+value+"}";
  }
}
