 ...
 * @param <T4> type of element for this implementation class
 ...
 */
class Union9NullableImp4<T1, T2, T3, T4, T5, T6, T7, T8, T9> implements Union9Nullable<T1, T2, T3, T4, T5, T6, T7, T8, T9> {
  @Nullable
  private final T4 value;

  Union9NullableImp4(@Nullable final T4 value) {
    this.value = value;
  }
  ...
  public boolean equals(final Object o) {
    ...
    final Union9NullableImp4<?, ?, ?, ?, ?, ?, ?, ?, ?> that = (Union9NullableImp4<?, ?, ?, ?, ?, ?, ?, ?, ?>) o;
  ...
  public String toString() {
    return "Union9NullableImp4{value="+value+"}";
  }
}
