 ...
 * @param <T9> the value type of element 9
...
public interface Function9<T1, T2, T3, T4, T5, T6, T7, T8, T9, R> {
   ...
   * @param p9 parameter 9
   * @return the result value
   * @throws Exception on error
   */
  @CheckReturnValue
  @Nonnull
  R apply(@Nonnull T1 p1, @Nonnull T2 p2, @Nonnull T3 p3, @Nonnull T4 p4, @Nonnull T5 p5,
          @Nonnull T6 p6, @Nonnull T7 p7, @Nonnull T8 p8, @Nonnull T9 p9) throws Exception;
}
