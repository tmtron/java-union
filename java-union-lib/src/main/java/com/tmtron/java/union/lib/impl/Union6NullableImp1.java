 ...
 */
class Union6NullableImp1<T1, T2, T3, T4, T5, T6> implements Union6Nullable<T1, T2, T3, T4, T5, T6> {
  @Nullable
  private final T1 value;

  Union6NullableImp1(@Nullable final T1 value) {
    this.value = value;
  }
  ...
  public boolean equals(final Object o) {
    ...
    final Union6NullableImp1<?, ?, ?, ?, ?, ?> that = (Union6NullableImp1<?, ?, ?, ?, ?, ?>) o;
  ...
  public String toString() {
    return "Union6NullableImp1{value="+value+"}";
  }
}
