 ...
 */
class Union9Imp2<T1, T2, T3, T4, T5, T6, T7, T8, T9> implements Union9<T1, T2, T3, T4, T5, T6, T7, T8, T9> {
  @Nonnull
  private final T2 value;

  Union9Imp2(@Nonnull final T2 value) {
  ...
  public boolean equals(final Object o) {
    ...
    final Union9Imp2<?, ?, ?, ?, ?, ?, ?, ?, ?> that = (Union9Imp2<?, ?, ?, ?, ?, ?, ?, ?, ?>) o;
