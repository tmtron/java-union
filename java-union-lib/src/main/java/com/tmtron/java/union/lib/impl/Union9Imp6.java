 ...
 */
class Union9Imp6<T1, T2, T3, T4, T5, T6, T7, T8, T9> implements Union9<T1, T2, T3, T4, T5, T6, T7, T8, T9> {
  @Nonnull
  private final T6 value;

  Union9Imp6(@Nonnull final T6 value) {
  ...
  public boolean equals(final Object o) {
    ...
    final Union9Imp6<?, ?, ?, ?, ?, ?, ?, ?, ?> that = (Union9Imp6<?, ?, ?, ?, ?, ?, ?, ?, ?>) o;
