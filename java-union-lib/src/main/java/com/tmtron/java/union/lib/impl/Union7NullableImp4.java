 ...
 */
class Union7NullableImp4<T1, T2, T3, T4, T5, T6, T7> implements Union7Nullable<T1, T2, T3, T4, T5, T6, T7> {
  @Nullable
  private final T4 value;

  Union7NullableImp4(@Nullable final T4 value) {
    this.value = value;
  }
  ...
  public boolean equals(final Object o) {
    ...
    final Union7NullableImp4<?, ?, ?, ?, ?, ?, ?> that = (Union7NullableImp4<?, ?, ?, ?, ?, ?, ?>) o;
  ...
  public String toString() {
    return "Union7NullableImp4{value="+value+"}";
  }
}
