 ...
 */
class Union5Imp3<T1, T2, T3, T4, T5> implements Union5<T1, T2, T3, T4, T5> {
  @Nonnull
  private final T3 value;

  Union5Imp3(@Nonnull final T3 value) {
  ...
  public boolean equals(final Object o) {
    ...
    final Union5Imp3<?, ?, ?, ?, ?> that = (Union5Imp3<?, ?, ?, ?, ?>) o;
