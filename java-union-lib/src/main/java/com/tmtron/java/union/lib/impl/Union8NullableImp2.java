 ...
 */
class Union8NullableImp2<T1, T2, T3, T4, T5, T6, T7, T8> implements Union8Nullable<T1, T2, T3, T4, T5, T6, T7, T8> {
  @Nullable
  private final T2 value;

  Union8NullableImp2(@Nullable final T2 value) {
    this.value = value;
  }
  ...
  public boolean equals(final Object o) {
    ...
    final Union8NullableImp2<?, ?, ?, ?, ?, ?, ?, ?> that = (Union8NullableImp2<?, ?, ?, ?, ?, ?, ?, ?>) o;
  ...
  public String toString() {
    return "Union8NullableImp2{value="+value+"}";
  }
}
