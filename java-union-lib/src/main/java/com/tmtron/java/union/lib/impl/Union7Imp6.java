 ...
 */
class Union7Imp6<T1, T2, T3, T4, T5, T6, T7> implements Union7<T1, T2, T3, T4, T5, T6, T7> {
  @Nonnull
  private final T6 value;

  Union7Imp6(@Nonnull final T6 value) {
  ...
  public boolean equals(final Object o) {
    ...
    final Union7Imp6<?, ?, ?, ?, ?, ?, ?> that = (Union7Imp6<?, ?, ?, ?, ?, ?, ?>) o;
