 ...
 */
class Union8Imp6<T1, T2, T3, T4, T5, T6, T7, T8> implements Union8<T1, T2, T3, T4, T5, T6, T7, T8> {
  @Nonnull
  private final T6 value;

  Union8Imp6(@Nonnull final T6 value) {
  ...
  public boolean equals(final Object o) {
    ...
    final Union8Imp6<?, ?, ?, ?, ?, ?, ?, ?> that = (Union8Imp6<?, ?, ?, ?, ?, ?, ?, ?>) o;
