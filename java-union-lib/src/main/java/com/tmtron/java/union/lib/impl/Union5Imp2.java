 ...
 */
class Union5Imp2<T1, T2, T3, T4, T5> implements Union5<T1, T2, T3, T4, T5> {
  @Nonnull
  private final T2 value;

  Union5Imp2(@Nonnull final T2 value) {
  ...
  public boolean equals(final Object o) {
    ...
    final Union5Imp2<?, ?, ?, ?, ?> that = (Union5Imp2<?, ?, ?, ?, ?>) o;
