 ...
 */
class Union5FactoryImpNullable<T1, T2, T3, T4, T5> implements Union5FactoryNullable<T1, T2, T3, T4, T5> {
  /**
  ...
  @CheckReturnValue
  @Override
  public final Union5Nullable<T1, T2, T3, T4, T5> element1(@Nullable T1 element1) {
    return new Union5NullableImp1<>(element1);
  }
  ...
  @CheckReturnValue
  @Override
  public final Union5Nullable<T1, T2, T3, T4, T5> element2(@Nullable T2 element2) {
    return new Union5NullableImp2<>(element2);
  }
  ...
  @CheckReturnValue
  @Override
  public final Union5Nullable<T1, T2, T3, T4, T5> element3(@Nullable T3 element3) {
    return new Union5NullableImp3<>(element3);
  }
  ...
  @CheckReturnValue
  @Override
  public final Union5Nullable<T1, T2, T3, T4, T5> element4(@Nullable T4 element4) {
    return new Union5NullableImp4<>(element4);
  }
  ...
  @CheckReturnValue
  @Override
  public final Union5Nullable<T1, T2, T3, T4, T5> element5(@Nullable T5 element5) {
    return new Union5NullableImp5<>(element5);
  }
}
