 ...
 */
class Union9Imp7<T1, T2, T3, T4, T5, T6, T7, T8, T9> implements Union9<T1, T2, T3, T4, T5, T6, T7, T8, T9> {
  @Nonnull
  private final T7 value;

  Union9Imp7(@Nonnull final T7 value) {
  ...
  public boolean equals(final Object o) {
    ...
    final Union9Imp7<?, ?, ?, ?, ?, ?, ?, ?, ?> that = (Union9Imp7<?, ?, ?, ?, ?, ?, ?, ?, ?>) o;
