 ...
 */
class Union6Imp3<T1, T2, T3, T4, T5, T6> implements Union6<T1, T2, T3, T4, T5, T6> {
  @Nonnull
  private final T3 value;

  Union6Imp3(@Nonnull final T3 value) {
  ...
  public boolean equals(final Object o) {
    ...
    final Union6Imp3<?, ?, ?, ?, ?, ?> that = (Union6Imp3<?, ?, ?, ?, ?, ?>) o;
