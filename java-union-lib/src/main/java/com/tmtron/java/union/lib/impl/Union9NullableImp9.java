 ...
 * @param <T9> type of element for this implementation class
 */
class Union9NullableImp9<T1, T2, T3, T4, T5, T6, T7, T8, T9> implements Union9Nullable<T1, T2, T3, T4, T5, T6, T7, T8, T9> {
  @Nullable
  private final T9 value;

  Union9NullableImp9(@Nullable final T9 value) {
    this.value = value;
  }
  ...
  public final void execute(@Nullable ConsumerNullable<T1> continuation1,
    ...
    try {
      if (continuation9 != null) {
        continuation9.accept(value);
      }
    } catch (Exception e) {
  ...
  public boolean equals(final Object o) {
    ...
    final Union9NullableImp9<?, ?, ?, ?, ?, ?, ?, ?, ?> that = (Union9NullableImp9<?, ?, ?, ?, ?, ?, ?, ?, ?>) o;
  ...
  public String toString() {
    return "Union9NullableImp9{value="+value+"}";
  }
}
