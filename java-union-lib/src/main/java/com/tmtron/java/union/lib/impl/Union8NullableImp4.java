 ...
 */
class Union8NullableImp4<T1, T2, T3, T4, T5, T6, T7, T8> implements Union8Nullable<T1, T2, T3, T4, T5, T6, T7, T8> {
  @Nullable
  private final T4 value;

  Union8NullableImp4(@Nullable final T4 value) {
    this.value = value;
  }
  ...
  public boolean equals(final Object o) {
    ...
    final Union8NullableImp4<?, ?, ?, ?, ?, ?, ?, ?> that = (Union8NullableImp4<?, ?, ?, ?, ?, ?, ?, ?>) o;
  ...
  public String toString() {
    return "Union8NullableImp4{value="+value+"}";
  }
}
