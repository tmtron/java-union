 ...
 */
class Union4Imp4<T1, T2, T3, T4> implements Union4<T1, T2, T3, T4> {
  @Nonnull
  private final T4 value;

  Union4Imp4(@Nonnull final T4 value) {
  ...
  public boolean equals(final Object o) {
    ...
    final Union4Imp4<?, ?, ?, ?> that = (Union4Imp4<?, ?, ?, ?>) o;
