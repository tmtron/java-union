 ...
 */
class Union9Imp5<T1, T2, T3, T4, T5, T6, T7, T8, T9> implements Union9<T1, T2, T3, T4, T5, T6, T7, T8, T9> {
  @Nonnull
  private final T5 value;

  Union9Imp5(@Nonnull final T5 value) {
  ...
  public boolean equals(final Object o) {
    ...
    final Union9Imp5<?, ?, ?, ?, ?, ?, ?, ?, ?> that = (Union9Imp5<?, ?, ?, ?, ?, ?, ?, ?, ?>) o;
