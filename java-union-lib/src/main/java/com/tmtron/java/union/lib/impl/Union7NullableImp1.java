 ...
 */
class Union7NullableImp1<T1, T2, T3, T4, T5, T6, T7> implements Union7Nullable<T1, T2, T3, T4, T5, T6, T7> {
  @Nullable
  private final T1 value;

  Union7NullableImp1(@Nullable final T1 value) {
    this.value = value;
  }
  ...
  public boolean equals(final Object o) {
    ...
    final Union7NullableImp1<?, ?, ?, ?, ?, ?, ?> that = (Union7NullableImp1<?, ?, ?, ?, ?, ?, ?>) o;
  ...
  public String toString() {
    return "Union7NullableImp1{value="+value+"}";
  }
}
