 ...
 */
class Union8NullableImp7<T1, T2, T3, T4, T5, T6, T7, T8> implements Union8Nullable<T1, T2, T3, T4, T5, T6, T7, T8> {
  @Nullable
  private final T7 value;

  Union8NullableImp7(@Nullable final T7 value) {
    this.value = value;
  }
  ...
  public boolean equals(final Object o) {
    ...
    final Union8NullableImp7<?, ?, ?, ?, ?, ?, ?, ?> that = (Union8NullableImp7<?, ?, ?, ?, ?, ?, ?, ?>) o;
  ...
  public String toString() {
    return "Union8NullableImp7{value="+value+"}";
  }
}
