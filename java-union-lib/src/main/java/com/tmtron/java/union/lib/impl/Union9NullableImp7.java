 ...
 */
class Union9NullableImp7<T1, T2, T3, T4, T5, T6, T7, T8, T9> implements Union9Nullable<T1, T2, T3, T4, T5, T6, T7, T8, T9> {
  @Nullable
  private final T7 value;

  Union9NullableImp7(@Nullable final T7 value) {
    this.value = value;
  }
  ...
  public boolean equals(final Object o) {
    ...
    final Union9NullableImp7<?, ?, ?, ?, ?, ?, ?, ?, ?> that = (Union9NullableImp7<?, ?, ?, ?, ?, ?, ?, ?, ?>) o;
  ...
  public String toString() {
    return "Union9NullableImp7{value="+value+"}";
  }
}
