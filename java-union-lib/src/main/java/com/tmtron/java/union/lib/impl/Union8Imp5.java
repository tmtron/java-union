 ...
 */
class Union8Imp5<T1, T2, T3, T4, T5, T6, T7, T8> implements Union8<T1, T2, T3, T4, T5, T6, T7, T8> {
  @Nonnull
  private final T5 value;

  Union8Imp5(@Nonnull final T5 value) {
  ...
  public boolean equals(final Object o) {
    ...
    final Union8Imp5<?, ?, ?, ?, ?, ?, ?, ?> that = (Union8Imp5<?, ?, ?, ?, ?, ?, ?, ?>) o;
