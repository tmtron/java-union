 ...
 */
class Union8Imp4<T1, T2, T3, T4, T5, T6, T7, T8> implements Union8<T1, T2, T3, T4, T5, T6, T7, T8> {
  @Nonnull
  private final T4 value;

  Union8Imp4(@Nonnull final T4 value) {
  ...
  public boolean equals(final Object o) {
    ...
    final Union8Imp4<?, ?, ?, ?, ?, ?, ?, ?> that = (Union8Imp4<?, ?, ?, ?, ?, ?, ?, ?>) o;
