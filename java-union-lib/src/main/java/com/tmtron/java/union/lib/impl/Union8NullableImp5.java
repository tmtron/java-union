 ...
 */
class Union8NullableImp5<T1, T2, T3, T4, T5, T6, T7, T8> implements Union8Nullable<T1, T2, T3, T4, T5, T6, T7, T8> {
  @Nullable
  private final T5 value;

  Union8NullableImp5(@Nullable final T5 value) {
    this.value = value;
  }
  ...
  public boolean equals(final Object o) {
    ...
    final Union8NullableImp5<?, ?, ?, ?, ?, ?, ?, ?> that = (Union8NullableImp5<?, ?, ?, ?, ?, ?, ?, ?>) o;
  ...
  public String toString() {
    return "Union8NullableImp5{value="+value+"}";
  }
}
