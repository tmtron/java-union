 ...
 */
class Union9Imp9<T1, T2, T3, T4, T5, T6, T7, T8, T9> implements Union9<T1, T2, T3, T4, T5, T6, T7, T8, T9> {
  @Nonnull
  private final T9 value;

  Union9Imp9(@Nonnull final T9 value) {
  ...
  public boolean equals(final Object o) {
    ...
    final Union9Imp9<?, ?, ?, ?, ?, ?, ?, ?, ?> that = (Union9Imp9<?, ?, ?, ?, ?, ?, ?, ?, ?>) o;
