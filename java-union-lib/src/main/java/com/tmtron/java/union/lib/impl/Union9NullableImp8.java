 ...
 * @param <T8> type of element for this implementation class
 * @param <T9> type of element
 */
class Union9NullableImp8<T1, T2, T3, T4, T5, T6, T7, T8, T9> implements Union9Nullable<T1, T2, T3, T4, T5, T6, T7, T8, T9> {
  @Nullable
  private final T8 value;

  Union9NullableImp8(@Nullable final T8 value) {
    this.value = value;
  }
  ...
  public final void execute(@Nullable ConsumerNullable<T1> continuation1,
      ...
      @Nullable ConsumerNullable<T8> continuation8, @Nullable ConsumerNullable<T9> continuation9) {
    try {
      if (continuation8 != null) {
        continuation8.accept(value);
      }
    } catch (Exception e) {
  ...
  public boolean equals(final Object o) {
    ...
    final Union9NullableImp8<?, ?, ?, ?, ?, ?, ?, ?, ?> that = (Union9NullableImp8<?, ?, ?, ?, ?, ?, ?, ?, ?>) o;
  ...
  public String toString() {
    return "Union9NullableImp8{value="+value+"}";
  }
}
