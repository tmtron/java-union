 ...
 */
class Union5NullableImp2<T1, T2, T3, T4, T5> implements Union5Nullable<T1, T2, T3, T4, T5> {
  @Nullable
  private final T2 value;

  Union5NullableImp2(@Nullable final T2 value) {
    this.value = value;
  }
  ...
  public boolean equals(final Object o) {
    ...
    final Union5NullableImp2<?, ?, ?, ?, ?> that = (Union5NullableImp2<?, ?, ?, ?, ?>) o;
  ...
  public String toString() {
    return "Union5NullableImp2{value="+value+"}";
  }
}
