 ...
 */
class Union8Imp8<T1, T2, T3, T4, T5, T6, T7, T8> implements Union8<T1, T2, T3, T4, T5, T6, T7, T8> {
  @Nonnull
  private final T8 value;

  Union8Imp8(@Nonnull final T8 value) {
  ...
  public final void execute(@Nullable Consumer<T1> continuation1,
      ...
      @Nullable Consumer<T8> continuation8) {
    try {
  ...
  public boolean equals(final Object o) {
    ...
    final Union8Imp8<?, ?, ?, ?, ?, ?, ?, ?> that = (Union8Imp8<?, ?, ?, ?, ?, ?, ?, ?>) o;
