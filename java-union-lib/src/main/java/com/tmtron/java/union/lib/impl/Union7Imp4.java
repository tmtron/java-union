 ...
 */
class Union7Imp4<T1, T2, T3, T4, T5, T6, T7> implements Union7<T1, T2, T3, T4, T5, T6, T7> {
  @Nonnull
  private final T4 value;

  Union7Imp4(@Nonnull final T4 value) {
  ...
  public boolean equals(final Object o) {
    ...
    final Union7Imp4<?, ?, ?, ?, ?, ?, ?> that = (Union7Imp4<?, ?, ?, ?, ?, ?, ?>) o;
