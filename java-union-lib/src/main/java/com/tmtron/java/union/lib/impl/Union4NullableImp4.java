 ...
 */
class Union4NullableImp4<T1, T2, T3, T4> implements Union4Nullable<T1, T2, T3, T4> {
  @Nullable
  private final T4 value;

  Union4NullableImp4(@Nullable final T4 value) {
    this.value = value;
  }
  ...
  public final void execute(@Nullable ConsumerNullable<T1> continuation1,
      ...
      @Nullable ConsumerNullable<T4> continuation4) {
    try {
  ...
  public boolean equals(final Object o) {
    ...
    final Union4NullableImp4<?, ?, ?, ?> that = (Union4NullableImp4<?, ?, ?, ?>) o;
  ...
  public String toString() {
    return "Union4NullableImp4{value="+value+"}";
  }
}
