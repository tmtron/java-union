 ...
 */
class Union9NullableImp6<T1, T2, T3, T4, T5, T6, T7, T8, T9> implements Union9Nullable<T1, T2, T3, T4, T5, T6, T7, T8, T9> {
  @Nullable
  private final T6 value;

  Union9NullableImp6(@Nullable final T6 value) {
    this.value = value;
  }
  ...
  public boolean equals(final Object o) {
    ...
    final Union9NullableImp6<?, ?, ?, ?, ?, ?, ?, ?, ?> that = (Union9NullableImp6<?, ?, ?, ?, ?, ?, ?, ?, ?>) o;
  ...
  public String toString() {
    return "Union9NullableImp6{value="+value+"}";
  }
}
