 ...
 */
class Union6NullableImp4<T1, T2, T3, T4, T5, T6> implements Union6Nullable<T1, T2, T3, T4, T5, T6> {
  @Nullable
  private final T4 value;

  Union6NullableImp4(@Nullable final T4 value) {
    this.value = value;
  }
  ...
  public boolean equals(final Object o) {
    ...
    final Union6NullableImp4<?, ?, ?, ?, ?, ?> that = (Union6NullableImp4<?, ?, ?, ?, ?, ?>) o;
  ...
  public String toString() {
    return "Union6NullableImp4{value="+value+"}";
  }
}
