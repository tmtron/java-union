 ...
 */
class Union2NullableImp1<T1, T2> implements Union2Nullable<T1, T2> {
  @Nullable
  private final T1 value;

  Union2NullableImp1(@Nullable final T1 value) {
    this.value = value;
  }
  ...
  public boolean equals(final Object o) {
    ...
    final Union2NullableImp1<?, ?> that = (Union2NullableImp1<?, ?>) o;
  ...
  public String toString() {
    return "Union2NullableImp1{value="+value+"}";
  }
}
