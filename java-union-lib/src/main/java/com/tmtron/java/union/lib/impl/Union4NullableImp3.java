 ...
 */
class Union4NullableImp3<T1, T2, T3, T4> implements Union4Nullable<T1, T2, T3, T4> {
  @Nullable
  private final T3 value;

  Union4NullableImp3(@Nullable final T3 value) {
    this.value = value;
  }
  ...
  public boolean equals(final Object o) {
    ...
    final Union4NullableImp3<?, ?, ?, ?> that = (Union4NullableImp3<?, ?, ?, ?>) o;
  ...
  public String toString() {
    return "Union4NullableImp3{value="+value+"}";
  }
}
