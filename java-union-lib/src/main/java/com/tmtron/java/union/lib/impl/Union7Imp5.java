 ...
 */
class Union7Imp5<T1, T2, T3, T4, T5, T6, T7> implements Union7<T1, T2, T3, T4, T5, T6, T7> {
  @Nonnull
  private final T5 value;

  Union7Imp5(@Nonnull final T5 value) {
  ...
  public boolean equals(final Object o) {
    ...
    final Union7Imp5<?, ?, ?, ?, ?, ?, ?> that = (Union7Imp5<?, ?, ?, ?, ?, ?, ?>) o;
