 ...
 */
class Union8Imp3<T1, T2, T3, T4, T5, T6, T7, T8> implements Union8<T1, T2, T3, T4, T5, T6, T7, T8> {
  @Nonnull
  private final T3 value;

  Union8Imp3(@Nonnull final T3 value) {
  ...
  public boolean equals(final Object o) {
    ...
    final Union8Imp3<?, ?, ?, ?, ?, ?, ?, ?> that = (Union8Imp3<?, ?, ?, ?, ?, ?, ?, ?>) o;
