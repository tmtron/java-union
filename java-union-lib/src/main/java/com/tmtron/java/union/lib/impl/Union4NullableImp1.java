 ...
 */
class Union4NullableImp1<T1, T2, T3, T4> implements Union4Nullable<T1, T2, T3, T4> {
  @Nullable
  private final T1 value;

  Union4NullableImp1(@Nullable final T1 value) {
    this.value = value;
  }
  ...
  public boolean equals(final Object o) {
    ...
    final Union4NullableImp1<?, ?, ?, ?> that = (Union4NullableImp1<?, ?, ?, ?>) o;
  ...
  public String toString() {
    return "Union4NullableImp1{value="+value+"}";
  }
}
