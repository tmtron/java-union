 ...
 */
class Union7Imp2<T1, T2, T3, T4, T5, T6, T7> implements Union7<T1, T2, T3, T4, T5, T6, T7> {
  @Nonnull
  private final T2 value;

  Union7Imp2(@Nonnull final T2 value) {
  ...
  public boolean equals(final Object o) {
    ...
    final Union7Imp2<?, ?, ?, ?, ?, ?, ?> that = (Union7Imp2<?, ?, ?, ?, ?, ?, ?>) o;
