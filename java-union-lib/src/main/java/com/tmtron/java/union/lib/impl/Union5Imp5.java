 ...
 */
class Union5Imp5<T1, T2, T3, T4, T5> implements Union5<T1, T2, T3, T4, T5> {
  @Nonnull
  private final T5 value;

  Union5Imp5(@Nonnull final T5 value) {
  ...
  public boolean equals(final Object o) {
    ...
    final Union5Imp5<?, ?, ?, ?, ?> that = (Union5Imp5<?, ?, ?, ?, ?>) o;
