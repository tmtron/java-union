 ...
 */
class Union2Imp2<T1, T2> implements Union2<T1, T2> {
  @Nonnull
  private final T2 value;

  Union2Imp2(@Nonnull final T2 value) {
  ...
  public final void execute(@Nullable Consumer<T1> continuation1,
      @Nullable Consumer<T2> continuation2) {
    try {
  ...
  public boolean equals(final Object o) {
    ...
    final Union2Imp2<?, ?> that = (Union2Imp2<?, ?>) o;
