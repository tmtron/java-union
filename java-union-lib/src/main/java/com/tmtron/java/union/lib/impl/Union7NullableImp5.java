 ...
 */
class Union7NullableImp5<T1, T2, T3, T4, T5, T6, T7> implements Union7Nullable<T1, T2, T3, T4, T5, T6, T7> {
  @Nullable
  private final T5 value;

  Union7NullableImp5(@Nullable final T5 value) {
    this.value = value;
  }
  ...
  public boolean equals(final Object o) {
    ...
    final Union7NullableImp5<?, ?, ?, ?, ?, ?, ?> that = (Union7NullableImp5<?, ?, ?, ?, ?, ?, ?>) o;
  ...
  public String toString() {
    return "Union7NullableImp5{value="+value+"}";
  }
}
