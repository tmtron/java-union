 ...
 */
class Union6Imp4<T1, T2, T3, T4, T5, T6> implements Union6<T1, T2, T3, T4, T5, T6> {
  @Nonnull
  private final T4 value;

  Union6Imp4(@Nonnull final T4 value) {
  ...
  public boolean equals(final Object o) {
    ...
    final Union6Imp4<?, ?, ?, ?, ?, ?> that = (Union6Imp4<?, ?, ?, ?, ?, ?>) o;
