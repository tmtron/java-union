 ...
 */
class Union4Imp1<T1, T2, T3, T4> implements Union4<T1, T2, T3, T4> {
  @Nonnull
  private final T1 value;

  Union4Imp1(@Nonnull final T1 value) {
  ...
  public boolean equals(final Object o) {
    ...
    final Union4Imp1<?, ?, ?, ?> that = (Union4Imp1<?, ?, ?, ?>) o;
