 ...
 */
class Union3NullableImp1<T1, T2, T3> implements Union3Nullable<T1, T2, T3> {
  @Nullable
  private final T1 value;

  Union3NullableImp1(@Nullable final T1 value) {
    this.value = value;
  }
  ...
  public boolean equals(final Object o) {
    ...
    final Union3NullableImp1<?, ?, ?> that = (Union3NullableImp1<?, ?, ?>) o;
  ...
  public String toString() {
    return "Union3NullableImp1{value="+value+"}";
  }
}
